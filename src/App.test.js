...
mockFetchShow.mockResolvedValue(testData);

test("Renders without errors", async () => {
  //this weird, I had to do some extra stuff
  //because.. at least I think because of the useEffect()
  // that runs on the component load
